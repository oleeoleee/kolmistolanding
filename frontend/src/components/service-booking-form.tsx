...
const fieldHeaderClassName = "mb-2 flex items-center justify-between gap-3";
const fieldLabelClassName =
  "text-[11px] font-semibold uppercase tracking-[0.16em] text-[var(--text-2)]";
const fieldMetaClassName =
  "inline-flex items-center rounded-full border border-[var(--border)] bg-[var(--surface-subtle)] px-2 py-1 text-[10px] font-semibold uppercase tracking-[0.12em] text-[var(--text-2)]";
const compactChipBaseClassName =
  "inline-flex min-h-[38px] cursor-pointer items-center justify-center rounded-full border px-3 py-2 text-[12px] font-semibold leading-4 tracking-[-0.01em] transition sm:min-h-10 sm:px-3.5 sm:text-[13px]";
      ...
      <form className="space-y-3.5 sm:space-y-4" noValidate onSubmit={handleSubmit}>
        <div className="space-y-2.5 border-b border-[var(--border)] pb-4">
          ...
          <input
            ...
            className="min-h-[54px] w-full rounded-[10px] border border-[var(--border-strong)] bg-[var(--surface)] px-4 text-[17px] leading-6 tracking-[-0.02em] text-[var(--text)] outline-none transition focus:border-[var(--primary)] focus:ring-4 focus:ring-[rgba(11,76,168,0.1)] sm:min-h-[56px] sm:text-[18px]"
          />
          {phoneError ? (
            <p
              id="phone-error"
        ...
        <div className="space-y-2.5 border-t border-[var(--border)] pt-3.5 sm:pt-4">
          <button
            ...
            className={`flex min-h-[44px] w-full items-center justify-between rounded-[10px] border px-4 text-left text-[13px] font-semibold leading-5 tracking-[-0.01em] transition sm:min-h-[46px] sm:text-[14px] ${
              expanded
            ...
            <div id="booking-comment" className="space-y-2.5">
              <div className="space-y-2">
                <textarea
                  ...
                  className="w-full rounded-[10px] border border-[var(--border)] bg-[var(--surface)] px-4 py-3 text-[15px] leading-6 tracking-[-0.01em] text-[var(--text)] outline-none transition focus:border-[var(--primary)] focus:ring-4 focus:ring-[rgba(11,76,168,0.1)]"
                />
              </div>
        ...
        <div className="space-y-3 pt-1.5">
          <button
            ...
            className="inline-flex min-h-[54px] w-full items-center justify-center rounded-[10px] bg-[var(--primary)] px-5 text-base font-semibold tracking-[-0.01em] text-white shadow-[0_12px_26px_rgba(11,76,168,0.2)] transition hover:bg-[var(--primary-pressed)] disabled:cursor-not-allowed disabled:opacity-70 sm:min-h-14"
          >
            {submitState === "submitting" ? "Отправляем..." : "Оставить заявку"}
          </button>
          <div className="grid gap-1.5 border-b border-[var(--border)] pb-3 text-[11px] font-medium uppercase tracking-[0.12em] text-[var(--text-2)] sm:grid-cols-3 sm:gap-2 sm:text-[10px]">
